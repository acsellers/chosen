  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      container_div = $("<div />", {
        ...
        "class": "chzn-container" + (this.is_rtl ? ' chzn-rtl' : '') + (this.extra_classes ? " " + this.extra_classes : ''),
        style: "" + (this.dont_calculate_width ? '' : 'width: ' + this.f_width + 'px;')
      });
      if (this.is_multiple) {
        container_div.html('<ul class="chzn-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off"  /></li></ul><div class="chzn-drop' + ("" + (this.extra_classes ? " " + this.extra_classes : '')) + '" style="left:-9000px;"><ul class="chzn-results"></ul></div>');
      } else {
